...
class TestView(TestCase):
	def setUp(self) -> None:
		...
		self.tag_python_kor=Tag.objects.create(name='파이썬 공부', slug='파이썬_공부')
	...
	def test_post_list(self):
		...
		self.assertIn(self.author.username,post_001_card.text)
		self.assertIn(self.tag_hello.name,post_001_card.text)
		self.assertIn(self.tag_python,post_001_card.text)
		...
		self.assertIn(self.author.username,post_002_card.text)
		self.assertIn(self.tag_hello.name,post_002_card.text)
		self.assertIn(self.tag_python,post_002_card.text)
		...
		self.assertIn(self.author.username,post_003_card.text)
